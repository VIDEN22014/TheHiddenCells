...
bool AppDelegate::applicationDidFinishLaunching() {
   ...
   SimpleAudioEngine::getInstance()->preloadEffect("SoundBlip.wav");
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("TheHiddenCells", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("TheHiddenCells");
#endif
